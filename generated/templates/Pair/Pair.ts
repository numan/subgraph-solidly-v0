...
export class Pair__claimFeesForResult {
  value0: BigInt;
  value1: BigInt;
...
export class Pair extends ethereum.SmartContract {
  ...
  claimFeesFor(recipient: Address): Pair__claimFeesForResult {
    let result = super.call(
      "claimFeesFor",
    ...
    return new Pair__claimFeesForResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_claimFeesFor(
    recipient: Address
  ): ethereum.CallResult<Pair__claimFeesForResult> {
    let result = super.tryCall(
      "claimFeesFor",
      "claimFeesFor(address):(uint256,uint256)",
      [ethereum.Value.fromAddress(recipient)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Pair__claimFeesForResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
...
export class ClaimFeesForCall extends ethereum.Call {
  get inputs(): ClaimFeesForCall__Inputs {
    return new ClaimFeesForCall__Inputs(this);
  }

  get outputs(): ClaimFeesForCall__Outputs {
    return new ClaimFeesForCall__Outputs(this);
  }
}

export class ClaimFeesForCall__Inputs {
  _call: ClaimFeesForCall;

  constructor(call: ClaimFeesForCall) {
    this._call = call;
  }
...
export class ClaimFeesForCall__Outputs {
  _call: ClaimFeesForCall;
